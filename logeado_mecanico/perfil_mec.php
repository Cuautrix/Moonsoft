  ...
  <body >
   ...
   <div class="wrapper fadeInDown">
    <div id="formContent">
      ...
      <?php
      include "../php/bd.php";
      $id=$_SESSION['id_session_mec'];

      $buscar =" SELECT * FROM  mecanico WHERE id_mec='$id'";
      ...
      if ($row = mysqli_fetch_array($resultado)) {
        ...
        $TEL_mec= $row['tel'];
        $EMAIL_mec= $row['email_mec'];
        $PASS_mec= $row['pass_mec'];
     
    }

    ?>  
      <!-- Login Form -->
      <form action="../php/mecanico_editar.php" method="POST">
      <div class="fadeIn second">
          <input type="text" id="login"  name="id" placeholder="Nombre" value="<?php echo $id_mec?>" readonly=»readonly» required >
        ...
        <div class="fadeIn second">
          <input type="email" id="login"  name="correo" placeholder="Correo Electronico" value="<?php echo $EMAIL_mec?>" required >
          <span class="material-symbols-outlined">mail</span>
        </div>
        <div class="fadeIn third">
          <input type="password" id="password" class="fadeIn third" name="pass" placeholder="Contraseña"  value="<?php echo $PASS_mec?>" required>
          <span class="material-symbols-outlined">key</span>
        </div>
        <div class="fadeIn third">
          <input type="text" id="login"  name="cel" placeholder="Numero Telefonico" value="<?php echo $TEL_mec?>" required >
