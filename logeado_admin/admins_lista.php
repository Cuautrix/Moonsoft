  ...
  <body >
    ...
    <nav class="navbar navbar-expand navbar-light bg-light" style="display: flex; justify-content: center;">
        <div class="nav navbar-nav">
            <a class="nav-item nav-link" style="color: black;" href="admins_lista.php" >Lista Administrador</a>
            <a class="nav-item nav-link" style="color: black;" href="admin_agregar.php" >Agregar Administrador</a>
        </div>
    </nav>
...
<?php
    ...
    {
                        echo "<tr>";
                        echo "<td>"; echo $filas ['id_admin']; echo "</td>";
                        echo "<td>"; echo $filas ['nombre']; echo "</td>";
                        echo "<td>"; echo $filas ['email_admin']; echo "</td>";
                        echo "<td>"; echo $filas ['tel']; echo "</td>";
                        echo "<td> 
                        <a href='../php/vehiculo_eliminar.php?id_admin=".$filas['id_admin']."'><button type='button' onclick='window.location.href='../php/vehiculo_eliminar.php'' class='btn btn-danger' >   Eliminar                         
                        </button> </a> </td>";
                        echo "</tr>";
