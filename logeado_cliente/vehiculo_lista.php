...
<!--Table head-->
    ...
    while($filas=mysqli_fetch_array($resultado))
    {
                        ...
                        echo "<td> <a href='./vehiculo_editar.php?placas=".$filas['placas']."'> <button type='button' class='btn btn-dark' style='background-color: #002463'>   Editar                           
                        </button> </a>
                        ǀ
                        <a href='../php/vehiculo_eliminar.php?placas=".$filas['placas']."'><button type='button' onclick='window.location.href='../php/vehiculo_eliminar.php'' class='btn btn-danger' >   Eliminar                         
                        </button> </a> </td>";
                        echo "</tr>";
